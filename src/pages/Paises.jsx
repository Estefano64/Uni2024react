                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={(event) => insertPais(event)}>
                            <div className="modal-body">
                                <div className="mb-3">
                                    <input type="text" className="form-control" placeholder="Código del País"
                                ...
                                <div className="mb-3">
                                    <input type="number" className="form-control" placeholder="Área"
                                        required
                                        value={area} onChange={(event) => setArea(event.target.value)}/>
                                </div>
                                <div className="mb-3">
                                    <input type="number" className="form-control" placeholder="Población"
                                        required
